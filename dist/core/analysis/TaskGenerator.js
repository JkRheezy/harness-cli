...
class TaskGenerator {
     ...
     */
    generateDescription(gap, target) {
     ...
     */
    generateRequirements(gap, target) {
        const requirements = [];
        switch (gap.type) {
            case 'missing_agent':
     ...
     */
    generateAcceptanceCriteria(gap, target) {
        const criteria = [];
        switch (gap.type) {
            case 'missing_agent':
                const agent = target.agents.find(a => a.name === gap.targetName);
