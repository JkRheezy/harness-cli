...
exports.CapabilityGapAnalyzer = void 0;
...
class CapabilityGapAnalyzer {
    ...
    isDuplicateGap(existingGaps, newGap) {
        return existingGaps.some(gap => gap.category === newGap.category &&
...
exports.CapabilityGapAnalyzer = CapabilityGapAnalyzer;
exports.default = CapabilityGapAnalyzer;
//# sourceMappingURL=CapabilityGapAnalyzer.js.map