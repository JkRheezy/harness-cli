...
class BusinessAnalyzer {
    constructor(config) {
        ...
        // 创建 LLM 调用函数
        const llmCaller = (prompt, model) => this.callLLM(prompt, model);
        // 初始化协调器
        ...
        this.coordinator = new analysis_1.AnalysisCoordinator(llmCaller, coordinatorConfig);
    }
    /**
     * 分析项目概述并生成业务架构
