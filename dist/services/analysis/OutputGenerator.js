...
class OutputGenerator {
     ...
     * 从综合结果生成最终输出
     */
    async generate(synthesis, projectName, overview) {
        // 构建生成 Prompt
        ...
        // 转换目录结构
        const directoryStructure = this.parseDirectoryStructure(synthesis.technical.directoryStructure);
     ...
     * 构建生成 Prompt
     */
    buildGenerationPrompt(synthesis) {
...
{\n  "tasks": [\n    {\n      "id": "task-001",\n      "name": "任务名称",\n      "description": "任务描述",\n      "priority": "high",\n      "acceptanceCriteria": ["标准1", "标准2"]\n    }\n  ]\n}`;
     ...
     */
    parseDirectoryStructure(structureText) {
